        ...
        <main>
            <div class="container-fluid px-4">
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('admin.store.pendaftaran') }}">
                            @csrf
                            ...
                            <div class="mb-3">
                                ...
                                <x-text-input id="umur" name="umur" type="number" class="mt-1 block w-full"  required autofocus autocomplete="umur" />
